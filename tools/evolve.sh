weight_root=/home/shanliang/workspace/code/yolov8/runs/WaterScenes-Tracking
dataset_root=/home/shanliang/workspace/dataset/tracking/YOLO/tracking/
...
python examples/evolve.py --yolo-model $weight_root/YOLOv8n2/weights/best.pt  --benchmark $dataset_root --split test --tracking-method deepocsort --objective HOTA --n-trials 100  # tune strongsort for MOT17
